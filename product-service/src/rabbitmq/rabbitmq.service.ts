...
export class RabbitmqService implements OnModuleInit, OnModuleDestroy {
  ...
  async requestResponse(exchange: string, routingKey: string, message: any, responsePattern: string): Promise<any> {
      ...
      try {
        ...
        await this.channel.consume(tempQueue, (msg) => {
          if (msg) {
            ...
            // Clean up
            this.channel.unbindQueue(tempQueue, exchange, responsePattern)
